...
// Validate validates this Id resource
func (m *IDResource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IDResource) validateCheckedID(formats strfmt.Registry) error {
...
func (m *IDResource) validateCheckedRawExternalID(formats strfmt.Registry) error {
...
func (m *IDResource) validateExternalID(formats strfmt.Registry) error {
...
func (m *IDResource) validateModel(formats strfmt.Registry) error {
...
func (m *IDResource) validateNew(formats strfmt.Registry) error {
...
func (m *IDResource) validateUID(formats strfmt.Registry) error {
...
// ContextValidate validate this Id resource based on the context it is used
func (m *IDResource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IDResource) contextValidateExternalID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IDResource) contextValidateModel(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IDResource) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IDResource) UnmarshalBinary(b []byte) error {
	var res IDResource
