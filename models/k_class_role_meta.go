...
// KClassRoleMeta KClass«RoleMeta»
//
// swagger:model KClass«RoleMeta»
...
// Validate validates this k class role meta
func (m *KClassRoleMeta) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *KClassRoleMeta) validateAbstract(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateAnnotations(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateCompanion(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateConstructors(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateData(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateFinal(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateInner(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateMembers(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateNestedClasses(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateObjectInstance(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateOpen(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateSealed(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateSealedSubclasses(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateSupertypes(formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) validateTypeParameters(formats strfmt.Registry) error {
...
var kClassRoleMetaTypeVisibilityPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		kClassRoleMetaTypeVisibilityPropEnum = append(kClassRoleMetaTypeVisibilityPropEnum, v)
	}
}

const (

	// KClassRoleMetaVisibilityPUBLIC captures enum value "PUBLIC"
	KClassRoleMetaVisibilityPUBLIC string = "PUBLIC"

	// KClassRoleMetaVisibilityPROTECTED captures enum value "PROTECTED"
	KClassRoleMetaVisibilityPROTECTED string = "PROTECTED"

	// KClassRoleMetaVisibilityINTERNAL captures enum value "INTERNAL"
	KClassRoleMetaVisibilityINTERNAL string = "INTERNAL"

	// KClassRoleMetaVisibilityPRIVATE captures enum value "PRIVATE"
	KClassRoleMetaVisibilityPRIVATE string = "PRIVATE"
)

// prop value enum
func (m *KClassRoleMeta) validateVisibilityEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, kClassRoleMetaTypeVisibilityPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *KClassRoleMeta) validateVisibility(formats strfmt.Registry) error {
...
// ContextValidate validate this k class role meta based on the context it is used
func (m *KClassRoleMeta) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *KClassRoleMeta) contextValidateConstructors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) contextValidateMembers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) contextValidateNestedClasses(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) contextValidateObjectInstance(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) contextValidateSealedSubclasses(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) contextValidateSupertypes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) contextValidateTypeParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KClassRoleMeta) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *KClassRoleMeta) UnmarshalBinary(b []byte) error {
	var res KClassRoleMeta
